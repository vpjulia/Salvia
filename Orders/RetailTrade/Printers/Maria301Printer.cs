...
namespace RetailTradeOrders.Printers
{
   public class Maria301Printer
    {
          ...
          public  int NumZ;
            ...
            private bool _GetPrinterConfig()
            {
                ...
                try
                {
                    ...
                    string tmp;
                    tmp = result.Substring(56, 8);

                    int Year = Convert.ToInt32(tmp.Substring(0,4));
                    int Month = Convert.ToInt32(tmp.Substring(4, 2));
                    int Day = Convert.ToInt32(tmp.Substring(6, 2));
        ...
        */
        ...
        public bool ZPeriodReport(DateTime dateFrom,DateTime dateTo)
        {
            if (this.HasError) return false;
            if (!this.Info.RefreshData()) return false;
            ...
            {
                this.ErrorText = "Поверните ключ в положение Z отчет";
                this.ErrorSender = "ZPeriodicalReport()";
                return false;
            }
            ...
            try
            {
                ...
                object res = _printer.GetType().InvokeMember("PeriodicalFiscalReportDate", BindingFlags.GetProperty, null, _printer, args);
                String result;
                result = res.ToString();
            }
        ...
        public bool OfExpend(decimal sum)
        { 
         ...
         if (this.KeyPosition != KeyPositions.Work)
         {
             this.ErrorText = "Поверните ключ в рабочее положение !";
             this.ErrorSender = "OfExpend";
             return false;
         }

         int sumExp = (int)(sum * 100); 
         ...
         try
         {
             res = _printer.GetType().InvokeMember("MoveCash", BindingFlags.GetProperty, null, _printer, args);
         ...
         {
             this.HasError = true;
             this.ErrorText = "Ошибка при инкассации: " + err.Message;
             this.ErrorSender = "OfExpend";
         ...
         {
             this.HasError = false;
             this.ErrorText = "Инкассация - успешно ";
             this.ErrorSender = "OfExpend";


             return  this.Info.RefreshData();
         }
         else
         {
             this.HasError = true;
             this.ErrorText = "Ошибка при инкассации" ;
             this.ErrorSender = "OfExpend";
