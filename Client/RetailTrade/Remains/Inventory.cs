    ...
    public partial class Inventory : UserControl
    {
        ...
        private void Inventory_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.inventoryMasterTableAdapter.Update(this.mDataSet.inventoryMaster);

                this.mDataSet.inventoryDetails.Clear();
        ...
        {
            if (this.inventoryMasterBindingSource.Count == 0 )return;
