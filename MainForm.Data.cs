...
namespace RetailTrade
{
   using System.Data;
...

    {
        ...
        {
            if (e.Row.HasVersion(DataRowVersion.Original) & e.Row.RowState == DataRowState.Unchanged)
            {
             if  ((e.Row as RetailTrade.MDataSet.ReceiptDetailRow).ReceiptMasterRow.RowState == DataRowState.Unchanged)
      ...
      //
        ...
        public bool FillTableNewDocuments(MDataSet.ReceiptMasterDataTable source)
       {
        ...
        {
            if (this.RefreshData(dbcx.Row as MDataSet.InvoiceMasterRow,false))
