...
using RetailTradeOrders.Receipt;

using RetailTradeOrders.Remains;
using System.IO;

using RetailTradeOrders.Printers;
using RetailTradeOrders.Dialog;
using RetailTradeOrders.Orders;
...
namespace RetailTradeOrders
{
    ...
    public partial class MainForm : Form
    {
        ...
        public static void Log(String logMessage )
        {
            ...
            {
                MessageBox.Show("Ошибка работы с файлами!" + err.Message);
                return;
            }
            ...
            {
                MessageBox.Show("Ошибка журнала!" + err.Message);
        ...
        public static void DeleteOldLogs()
        {
            ...
            {
                MessageBox.Show("Очистка журнала : "+err.Message);
            }
        ...
        */
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
         ...
         //   MessageBox.Show(app.GetValue("RetailTradeConnectionString", System.Type.GetType("System.String")).ToString());
            ...
            this.ShowNewDataTab("OrdersAll", "Заказы");
     ...
     */
      ...
      /*  private UserControl InitInvoiceRow(ref string TagControl, ref string Title, params object[] list)
        ...
        private UserControl InitOrdersAll(ref String TagControl, ref string Title)
        {
            ...
            usControl = new OrdersAll(this.mDataSet);
